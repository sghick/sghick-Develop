...
#import "UIDevice+WP.h"

@implementation UIDevice (WP)
...
- (NSString *)wp_deviceType{
    NSString * deviceString = [self wp_deviceString];
...
- (BOOL)wp_isIPhone6{
    if ([@"iPhone7,2" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    return NO;
}
...
- (BOOL)wp_isIPhone6Plus{
    if ([@"iPhone7,1" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    return NO;
}
...
- (BOOL)wp_isIPhone5{
    if ([@"iPhone5,1" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    if ([@"iPhone5,2" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    return NO;
}
...
- (BOOL)wp_isIPhone5s{
    if ([@"iPhone6,1" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    if ([@"iPhone6,2" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    return NO;
}
...
- (BOOL)wp_isIPhone4s{
    if ([@"iPhone4,1" isEqualToString:[self wp_deviceString]] ) {
        return YES;
    }
    return NO;
}
